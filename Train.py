...
# data = pd.read_csv('FinalGender.csv')
...
# Convert text data into numerical data using TF-IDF without converting to dense
tfidf = TfidfVectorizer(analyzer='char', ngram_range=(1, 2))
X = tfidf.fit_transform(data['Name'])  # Keep it sparse
...
model.save('gender_prediction_model_onLarge.h5')

# Save the TF-IDF vectorizer
dump(tfidf, 'tfidf_vectorizer_onLarge.joblib')
